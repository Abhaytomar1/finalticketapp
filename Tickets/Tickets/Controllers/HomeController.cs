...
namespace Tickets.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            // Example of fetching data (adjust according to your actual data source and structure)
            var ticketsCreatedByDate = _context.Tickets // Replace _context with your actual data context
                .GroupBy(t => t.CreatedAt.Date)
                .Select(g => new TicketsCreatedByDate
                {
                    Date = g.Key,
